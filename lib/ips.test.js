...
describe('IPS data string generator', () => {
    ...
    it('should work with required arguments', async () => {
        ...
        const result = 'K:PR|V:01|C:1|R:123456789012345611|N:JEST Ltd., Test|I:RSD1295,|SF:123|S:Testing|RS:test-2020';
    ...
    it('should generate valid model and call number', async () => {
        ...
        const result = 'K:PR|V:01|C:1|R:123456789012345611|N:JEST Ltd., Test|I:RSD1295,|SF:123|S:Testing|RO:972012345|RS:test-2020';
        await expect(generateIpsDataString(args)).resolves.toBe(result);
    });
});
