...
const { validatePozivNaBroj } = require('./utils.js');
...
module.exports = yup.object({
  ...
  ro: yup.string()
    .min(0)
    .max(35)
    .test('poziv-na-broj', "Model i poziv na broj moraju da prate sledeci format: MMKKBBB...B (MM-model, KK-kontrolni broj, BBB...B broj)", value => {
